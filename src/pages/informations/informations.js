        ...
        <>
            <Container className="text-color-2 informations">
                <Row>
                    ...
                    <p className="mb-5">Nom du site : Via Commu<br/>Type de site : Blog<br/>Responsable de la publication : [Nom ou pseudonyme]<br/>Email de contact : <a className="mailto" href="mailto:contact@viacommu.com.">contact@viacommu.com.</a><br/>Hébergement : [Nom de l'hébergeur] - [Adresse de l'hébergeur]</p>
                </Row>
                <Row>
                ...
                <Row>
                    ...
                    <p className="mb-5">Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression de vos données. Pour toute demande, contactez-nous à <a className="mailto" href="mailto:contact@viacommu.com.">contact@viacommu.com.</a></p>
                </Row>
            </Container>
        </>
    )
